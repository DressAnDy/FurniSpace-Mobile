...
export const linking: LinkingOptions<RootStackParamList> = {
  ...
  config: {
    screens: {
      ...
      DesignerProjects: "designer/projects",
      DesignerSchedules: "designer/schedules",
      DesignerProjectDetail: "designer/projects/:projectId",
      DesignerMessages: "designer/messages",
      DesignerMore: "designer/more",
      Profile: "profile",
      Register: "register",
